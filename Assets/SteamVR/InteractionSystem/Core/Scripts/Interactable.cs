...
namespace Valve.VR.InteractionSystem
{
	...
	public class Interactable : MonoBehaviour
    {
        ...
        private void CreateHighlightRenderers()
        {
            ...
            existingSkinnedRenderers = (!objectToHighlight)?this.GetComponentsInChildren<SkinnedMeshRenderer>(true): objectToHighlight.GetComponentsInChildren<SkinnedMeshRenderer>(true);
